const CACHE='gym-template-rir-v9-layout-history-delete';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./apple-touch-icon.png','./apple-touch-icon-180x180.png'];
